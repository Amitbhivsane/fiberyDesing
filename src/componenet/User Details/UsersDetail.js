...
const UsersDetail = (onClose, isVisible) => {
    ...
    <>
      <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
        <div className="w-full sm:w-[80%] flex flex-col bg-white rounded-lg overflow-hidden">
          <button
            className="text-white text-xl place-self-end p-2"
            onClick={() => onClose}
          >
            X
          </button>
                ...
                <div className="mb-8">
                  ...
                  <div class="w-full">
                    <form class="px-8 pt-6 pb-8 mb-4">
                      ...
                      <div>
                        <h3 class=" font-semibold text-gray-900 dark:text-white m-2">
                          Please, share with us the name of your Fibery
                          workspace (if any)
                        </h3>
                      ...
                      <div>
                        <p class="text-center text-gray-500 text-xs m-5">
                          ...
                          agree to Calendly's Terms of Use and Privacy Notice.
                        </p>
                      </div>
